...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/curly-mountain-efb5)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/curly-mountain-efb5
```

A live public deployment of this template is available at [https://curly-mountain-efb5.templates.workers.dev](https://curly-mountain-efb5.templates.workers.dev)
